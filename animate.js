window.onload = function(){
  ...
  var name = {
      ...
      draw: function(){
          ...
          ctx.fillText("R", (this.x - 37.5), this.y);

          ctx.fillStyle = this.color_4;
          ctx.fillText("I", (this.x + 37.5), this.y);

          ctx.fillStyle = this.color_5;
          ctx.fillText("T", (this.x + 112.5), this.y);

          ctx.fillStyle = this.color_6;
          ctx.fillText("I", (this.x + 187.5), this.y);
      },
      ...
      update: function(){
          ...
          if(this.alpha_6 > 11){
            if(this.fade){
              $('canvas').fadeOut(2000);
              $('#txt').delay(3000).fadeIn(2000).delay(2000).fadeOut(2000);
              this.fade = false;
            }
          }
      }
